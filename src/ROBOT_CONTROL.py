...
class ROBOT():
    ...
    def t_up(self,speed=50,t_time=0):
        ...
        time.sleep(t_time)
    #后退
    def t_down(self,speed=50,t_time=0):
    ...
    # 左移
    def moveLeft(self,speed=50,t_time=0):
        self.MotorRun(0,'backward',speed)
        self.MotorRun(1,'forward',speed)
        self.MotorRun(2,'forward',speed)
        self.MotorRun(3,'backward',speed)
    ...
    #右移
    def moveRight(self,speed=50,t_time=0):
        self.MotorRun(0,'forward',speed)
        self.MotorRun(1,'backward',speed)
        self.MotorRun(2,'backward',speed)
        self.MotorRun(3,'forward',speed)
    ...
    # 左转
    def turnLeft(self,speed=50,t_time=0):
        self.MotorRun(0,'backward',speed)
        self.MotorRun(1,'forward',speed)
        self.MotorRun(2,'backward',speed)
        self.MotorRun(3,'forward',speed)
    ...
    # 右转
    def turnRight(self,speed=50,t_time=0):
        self.MotorRun(0,'forward',speed)
        self.MotorRun(1,'backward',speed)
        self.MotorRun(2,'forward',speed)
        self.MotorRun(3,'backward',speed)
    ...
    # 前左斜
    def forward_Left(self,speed=50,t_time=0):
        self.MotorStop(0)
        self.MotorRun(1,'forward',speed)
        self.MotorRun(2,'forward',speed)
        self.MotorStop(0)
